...
export const metadata: Metadata = {
  title: "Shivansh Jasathi | Software Developer",
  description:
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Shivansh Jasathi| Software Developer",
      },
    ],
  },
  twitter: {
  ...
  creator: "Shivansh Jasathi",
  publisher: "Shivansh jasathi",
};
